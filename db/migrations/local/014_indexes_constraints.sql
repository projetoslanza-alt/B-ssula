-- Migration local: 014_indexes_constraints.sql
-- Gerado por build-local-migrations.ts

-- source: 20250629120000_security_fixes.sql
...
BEGIN
  ...
  WHERE user_id = NULL::uuid AND tenant_id = v_course.tenant_id AND status = 'active';
  ...
  WHERE r.course_id = p_course_id
    AND (
      ...
      OR (r.rule_type = 'user' AND r.target_id = NULL::uuid)
...
-- source: 20250630140000_qa_test_markers.sql
