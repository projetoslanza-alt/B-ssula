...
export const PLATFORM_MODULES: PlatformModule[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: r.learning.admin, label: "Gestão da Universidade", permissionsAny: ["learning.course.create", "learning.course.manage", "learning.enrollment.manage"] },
      { href: r.learning.adminPaths, label: "Trilhas", permission: "learning.path.manage" },
      { href: r.learning.adminEnrollments, label: "Matrículas", permission: "learning.enrollment.manage" },
